...
function Sidebar() {
  ...
  return (   
      ...
      <div className="flex gap-4 hover:text-white cursor-pointer" >
      <IoDocumentText/>
      <a href={downloadUrl} className="text-sm font-semibold hidden group-hover:block ">Resume</a>
      </div>
      <div className="group-hover:flex gap-4 hover:text-white cursor-pointer  hidden " >
      <BsCalendar2Fill className="hidden group-hover:block" />
      <p className="text-sm font-semibold hidden group-hover:block ">Projects</p>
      </div>
      <div className="flex gap-4 hover:text-white cursor-pointer" >
      <IoPersonSharp/>
      <p className="text-sm font-semibold hidden group-hover:block ">About</p>
      </div>
      <div className="group-hover:flex gap-4 hover:text-white cursor-pointer  hidden " >
      <FaToolbox className="hidden group-hover:block "/>
      <p className="text-sm font-semibold hidden group-hover:block ">ToolStack</p>
      </div>
      <div className="flex gap-4 hover:text-white cursor-pointer  " >
      <BiSolidMessageSquareDots/>
      <p className="text-sm font-semibold hidden group-hover:block ">Contact</p>
      </div>
      </div>
  )
}
